...
CREATE TABLE TB_STUDENT (
    ...
    ENTRANCE_DATE DATE,
    ABSENCE_YN CHAR(1) CHECK(ABSENCE_YN IN('N', 'Y')),
...
CREATE TABLE TB_CLASS_PROFESSOR (
    ...
    PROFESSOR_NO VARCHAR2(10) REFERENCES TB_PROFESSOR(PROFESSOR_NO) NOT NULL
);
COMMENT ON COLUMN TB_CLASS.CLASS_NO IS '과목 번호';
COMMENT ON COLUMN TB_CLASS.DEPARTMENT_NO IS '학과 번호';
COMMENT ON COLUMN TB_CLASS.PREATTENDING_NO IS '선수 과목 번호';
